...
class Rectangle{
  ...
  //Crta platformu. Platforme su automatski bijele, nacrtane na crnoj
  //pozadini se vide. Ova funkcija se poziva samo kad se postavljaju platforme
  //ili kad se neke funkcije provjeravaju. Inače u pravoj verziji igre se ne 
  //crtaju
  void draw(){
    /*fill(fillColor);
    stroke(borderColor);
